...
const TopBanner = () => {
  return (
    <div className="top-banner bg-black  mb-10 relative text-center">
      ...
      <div className="absolute md:bottom-1/3 bottom-1/4 right-1/2 translate-x-1/2 text-white md:mt-5 mt-2 ">
        <h1 className="md:text-5xl text-2xl text-center ">
          Develop Your Skill By Taking Quizzes
        </h1>

        <div className="flex justify-center">
          <button className="  border border-white md:mt-10 mt-2 p-3  bg-indigo-600 rounded-lg hover:bg-indigo-900">
